...
export type MutationFieldPolicy = {
	...
	productReviewModerate?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type ProductReviewKeySpecifier = ('createdAt' | 'id' | 'image1' | 'image2' | 'isPublished' | 'moderatedAt' | 'moderatedBy' | 'product' | 'rating' | 'text' | 'user' | ProductReviewKeySpecifier)[];
export type ProductReviewFieldPolicy = {
	createdAt?: FieldPolicy<any> | FieldReadFunction<any>,
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	image1?: FieldPolicy<any> | FieldReadFunction<any>,
	image2?: FieldPolicy<any> | FieldReadFunction<any>,
	isPublished?: FieldPolicy<any> | FieldReadFunction<any>,
	moderatedAt?: FieldPolicy<any> | FieldReadFunction<any>,
	moderatedBy?: FieldPolicy<any> | FieldReadFunction<any>,
	product?: FieldPolicy<any> | FieldReadFunction<any>,
	rating?: FieldPolicy<any> | FieldReadFunction<any>,
	text?: FieldPolicy<any> | FieldReadFunction<any>,
	user?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ProductReviewCreateKeySpecifier = ('errors' | 'review' | ProductReviewCreateKeySpecifier)[];
export type ProductReviewCreateFieldPolicy = {
	errors?: FieldPolicy<any> | FieldReadFunction<any>,
	review?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ProductReviewModerateKeySpecifier = ('errors' | 'review' | ProductReviewModerateKeySpecifier)[];
export type ProductReviewModerateFieldPolicy = {
	errors?: FieldPolicy<any> | FieldReadFunction<any>,
	review?: FieldPolicy<any> | FieldReadFunction<any>
};
...
export type QueryKeySpecifier = ('_entities' | '_service' | 'address' | 'addressValidationRules' | 'app' | 'appExtension' | 'appExtensions' | 'apps' | 'appsInstallations' | 'attribute' | 'attributes' | 'categories' | 'category' | 'channel' | 'channels' | 'checkout' | 'checkoutLines' | 'checkouts' | 'collection' | 'collections' | 'customers' | 'digitalContent' | 'digitalContents' | 'draftOrders' | 'exportFile' | 'exportFiles' | 'giftCard' | 'giftCardCurrencies' | 'giftCardSettings' | 'giftCardTags' | 'giftCards' | 'homepageEvents' | 'me' | 'menu' | 'menuItem' | 'menuItems' | 'menus' | 'order' | 'orderByToken' | 'orderSettings' | 'orders' | 'ordersTotal' | 'page' | 'pageType' | 'pageTypes' | 'pages' | 'payment' | 'payments' | 'permissionGroup' | 'permissionGroups' | 'plugin' | 'plugins' | 'product' | 'productReviewsPending' | 'productReviewsPublished' | 'productType' | 'productTypes' | 'productVariant' | 'productVariants' | 'products' | 'promotion' | 'promotions' | 'refundSettings' | 'reportProductSales' | 'sale' | 'sales' | 'shippingZone' | 'shippingZones' | 'shop' | 'staffUsers' | 'stock' | 'stocks' | 'taxClass' | 'taxClasses' | 'taxConfiguration' | 'taxConfigurations' | 'taxCountryConfiguration' | 'taxCountryConfigurations' | 'taxTypes' | 'transaction' | 'translation' | 'translations' | 'user' | 'voucher' | 'vouchers' | 'warehouse' | 'warehouses' | 'webhook' | 'webhookEvents' | 'webhookSamplePayload' | QueryKeySpecifier)[];
export type QueryFieldPolicy = {
	...
	product?: FieldPolicy<any> | FieldReadFunction<any>,
	productReviewsPending?: FieldPolicy<any> | FieldReadFunction<any>,
	productReviewsPublished?: FieldPolicy<any> | FieldReadFunction<any>,
	productType?: FieldPolicy<any> | FieldReadFunction<any>,
	productTypes?: FieldPolicy<any> | FieldReadFunction<any>,
	productVariant?: FieldPolicy<any> | FieldReadFunction<any>,
	productVariants?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type StrictTypedTypePolicies = {
	...
	ProductReviewCreate?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ProductReviewCreateKeySpecifier | (() => undefined | ProductReviewCreateKeySpecifier),
		fields?: ProductReviewCreateFieldPolicy,
	},
	ProductReviewModerate?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ProductReviewModerateKeySpecifier | (() => undefined | ProductReviewModerateKeySpecifier),
		fields?: ProductReviewModerateFieldPolicy,
	},
